      ...
      <div className="max-w-6xl mx-auto px-5">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div>
            ...
            <p className="text-lg mb-6 text-slate-900">Originally from the UK, I lived in Berlin for 12 years and speak fluent German, French, and am currently immersing myself in Spanish after moving to Valencia last year. When I'm not coding, I'm likely producing music, playing the guitar, taking photographs, or getting lost in a good book.</p>
